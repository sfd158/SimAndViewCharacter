...
#    dSpaceID dHashSpaceCreate(int space)
    ...
    void dSpaceCollide (dSpaceID space, void *data, void (*callback)(void* , dGeomID, dGeomID))
...
# This function is added by Libin Liu
cdef extern from "SpecifiedBoxGroundCD.h":
