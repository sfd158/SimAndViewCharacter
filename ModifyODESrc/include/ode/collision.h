...
ODE_API void dGeomRenderGetUserColor(dGeomID g, dReal * result);

// Add by Zhenhua Song, for visualize in Long Ge's draw stuff framework
ODE_API void dGeomRenderInUserColor(dGeomID g, const dReal * input_arr);

// Add by Zhenhua Song, for visualize in Long Ge's draw stuff framework
ODE_API void dGeomRenderInDefaultColor(dGeomID g, int value);

// Add by Zhenhua Song, for visualize in Long Ge's draw stuff framework
ODE_API int dGeomIsRenderInDefaultColor(dGeomID g);
...
// ODE_API void dSpaceCollideWrapper (dSpaceID space, dNearCallbackData *data, dNearCallback *callback);
...
ODE_API Vector2Wrapper dGeomCapsuleGetParamsWrapper (dGeomID ccylinder);
...
ODE_API Vector2Wrapper dGeomCylinderGetParamsWrapper (dGeomID cylinder);
