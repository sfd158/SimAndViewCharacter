...
// same order as Unity and scipy lib in python.
struct Quat4Wrapper{
  dReal x, y, z, w;
};
...
ODE_API void dBodySetQuaternionWrapper2(dBodyID body, double x, double y, double z, double w);
...
ODE_API Vector3Wrapper dBodyGetLinearVelWrapper (dBodyID);
