...
// Add by Zhenhua Song
typedef struct dNearCallBackData
{
    size_t ignore_geom_buf[64];
    size_t ignore_geom_buf_len;
} dNearCallbackData;

typedef void dNearCallbackWrapper(dNearCallbackData *, dGeomID, dGeomID);
