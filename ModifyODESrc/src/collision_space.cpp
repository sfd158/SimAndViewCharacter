...
Vector2IntWrapper dHashSpaceGetLevelsWrapper (dSpaceID space)
{
  int a, b;
  dHashSpaceGetLevels(space, &a, &b);
  return {a, b};
}
...
//void dSpaceCollideWrapper (dSpaceID space, dNearCallbackData *data, dNearCallbackWrapper *callback)
//{
