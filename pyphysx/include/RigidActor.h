...
public:
    ...
    auto get_name() const
    {
        return get_physx_ptr()->getName();
    }

    // Add by Zhenhua Song
    void set_name(const char * name)
    {
        get_physx_ptr()->setName(name);
    }

    // Add by Zhenhua Song
    auto get_actor_flags() const
    {
        return get_physx_ptr()->getActorFlags();
    }

    // Add by Zhenhua Song
    void set_actor_flags(physx::PxActorFlags flags)
    {
        get_physx_ptr()->setActorFlags(flags);
    }
};
