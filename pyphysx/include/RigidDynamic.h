...
public:
    ...
    // Add by Zhenhua Song
    auto get_mass_space_inertia()
    {
        return get_dyn_ptr()->getMassSpaceInertiaTensor();
        
    }

    // Add by Zhenhua Song
    void set_mass_space_inertia(const physx::PxVec3 & m)
    {
        get_dyn_ptr()->setMassSpaceInertiaTensor(m);
    }
