...
PYBIND11_MODULE(pyphysx, m) {
    ...
    py::class_<Scene>(m, "Scene")
            ...
            .def("getBodyPos", &Scene::getBodyPos)
            .def("getBodyQuatScipy", &Scene::getBodyQuatScipy)
            .def("getBodyLinVel", &Scene::getBodyLinVel)
            .def("getBodyAngVel", &Scene::getBodyAngVel)
            .def("getBodyInfoState", &Scene::GetBodyInfoState)
            .def("getBodyMass", &Scene::getBodyMass)
            .def("getBodyInertia", &Scene::getBodyInertia);
    ...
    py::class_<RigidActor>(m, "RigidActor")
            ...
            .def("get_name", &RigidActor::get_name)
            .def("set_name", &RigidActor::set_name, arg("name"));
    ...
    py::class_<ArticulationJointRC>(m, "ArticulationJointRC");
